...
public class MainActivity extends Activity implements OnClickListener, OnItemClickListener, OnPageChangeListener {
	...
	private void initViewPager() {
		...
		SimpleAdapter simpleAdapter = new SimpleAdapter(getApplicationContext(), listItems, R.layout.singleexpression, new String[] { "image" }, new int[] { R.id.image });
	...
	public void onPageSelected(int arg0) {
		...
		case 2:
			...
			SimpleAdapter simpleAdapter1 = new SimpleAdapter(getApplicationContext(), listItems1, R.layout.singleexpression, new String[] { "image" }, new int[] { R.id.image });
